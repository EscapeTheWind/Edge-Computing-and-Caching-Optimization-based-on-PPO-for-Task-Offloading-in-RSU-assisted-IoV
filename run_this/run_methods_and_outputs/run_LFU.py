...
from envs import LFU_environment
...
def train(args):
    ...
    env = LFU_environment.RoadState()
    env_evaluate = LFU_environment.RoadState()  # When evaluating the policy, we need to rebuild an environment
