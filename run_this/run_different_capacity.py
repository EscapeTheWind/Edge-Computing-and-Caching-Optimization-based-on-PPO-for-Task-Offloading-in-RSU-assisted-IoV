...
from run_this.run_methods_and_outputs.run_capacity1 import *
from run_this.run_methods_and_outputs.run_capacity2 import *
from utils import *
...
reward1, ma_hit_rate1, time1, ma_all_hit_rate1, args1 = run_capacity_1();
# 保存all hit ratio曲线
with open("./data/all_hitrate.txt", "a") as file:
    file.write(str(ma_all_hit_rate1) + "\n")

reward2, ma_hit_rate2, time2, ma_all_hit_rate2, args2 = run_capacity_2();
# 保存all hit ratio曲线
with open("./data/all_hitrate.txt", "a") as file:
...
if len(lines) == 3:
    plot_hit_rate_with_different_capacities(args, tag='train')
else:
